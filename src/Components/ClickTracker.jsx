...
function ClickTracker() {
  ...
  return (
    <div>
      <button className=" ml-5 mt-6 bg-transparent hover:bg-blue-400 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded" onClick={handleClick}>Click me!</button>
